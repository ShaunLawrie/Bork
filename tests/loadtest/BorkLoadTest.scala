...
class BorkLoadTest extends Simulation {
  ...
  // Set up simulation
  setUp(
    pollingStats.inject(rampUsers(100) over(300 seconds)),
    pollingBorks.inject(rampUsers(100) over(300 seconds)),
    creatingBorks.inject(rampUsers(100) over(300 seconds)),
    reBorking.inject(rampUsers(100) over(300 seconds)),
    other.inject(rampUsers(100) over(300 seconds))
